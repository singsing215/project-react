        ...
        return (
                <div id="footer" class="fixed-bottom">
                    <footer>
                        <div class="container">
                            <div class="row">
                                <div class="col-12 col-sm-8 col-lg-4 col-xl-4 text-left" style={{ padding: 0 }}>
                                    <img src={logo}></img>
                                    <h5 id="links">Real Estate Rental System</h5>
                                    <p class="lead">Simple and easy-to-use rental system can find roommates for you.
                        </p>
                                </div>
                                <div class="col-0 col-sm-0 col-lg-4 col-xl-4 text-left" id="link">
                                ...
                                <div class="col-0 col-sm-4 col-lg-4 col-xl-4 text-left" id="contact">
                                    <h5>Contact Me</h5>
